...
const tabContent: Record<string, { title: string; content: string }> = {
  ...
  "new-submission": { title: "New submission", content: "New submission content goes here." },
  "history": { title: "History", content: "History content goes here." },
  "statistics": { title: "Statistics", content: "Statistics content goes here." },
  "scoring-system": { title: "Scoring system", content: "Scoring system content goes here." },
  "user-setting": { title: "User setting", content: "User setting content goes here." },
};
